...
4. Для "low" або "medium" confidence — ОБОВ'ЯЗКОВО додай поле в unclear_fields з:
   - "raw_chars": текст НОРМАЛЬНИМИ СЛОВАМИ як ти його прочитав. НЕ розбивай на окремі літери!
     ПРАВИЛЬНО: "ілюстративний фріланс, ходжу писати картини"
     НЕПРАВИЛЬНО: "і л ю с т р а т и в н о м у" або "і-л-ю-с-т-р-а-т-и-в-н-о-м-у"
